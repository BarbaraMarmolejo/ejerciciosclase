...
GLfloat sa_shininess[] = { 100.0 };
					// Color background
GLfloat uradiffuse[] = { 0.133337, 0.9001, 0.713, 1.0 };					// Object Color main
GLfloat uraspecular[] = { 0.133337, 0.9001, 0.713, 1.0 };				// Specular color
GLfloat urashininess[] = { 100.0 };

				// Color background
GLfloat nepdiffuse[] = { 0.145, 0.125, 0.835, 1.0 };					// Object Color main
GLfloat nepspecular[] = { 0.145, 0.125, 0.835, 1.0 };				// Specular color
GLfloat nepshininess[] = { 100.0 };
