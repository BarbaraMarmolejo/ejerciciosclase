...
//hacer un baile mediante key frames 
...
float posX = 0, posY = 2.5, posZ = -3.5, rotRodIzq = 0, rotRodDer = 0, movcuello = 0, brazoizq = 0, brazoder; //variables para manipular monito
float giroMonito = 0;
...
typedef struct _frame
{
	...
	float rorRodDer;
	float rotRodIzq; 
	float rotInc,rotbraizqinc,rotbraderinc,rotcuelloinc;
	float rodDerInc;
	float giroMonito;
	float giroMonitoInc;
...
void saveFrame ( void )
{
	...
	KeyFrame[FrameIndex].rorRodDer = rotRodDer;
	KeyFrame[FrameIndex].rotRodIzq=rotRodIzq;
	KeyFrame[FrameIndex].rodbrazoder = brazoder;
	KeyFrame[FrameIndex].rodbrazoizq = brazoizq;
	KeyFrame[FrameIndex].rodmovcuello = movcuello;
...
void resetElements(void)
{
	...
	rotRodDer = KeyFrame[0].rorRodDer;
	rotRodIzq = KeyFrame[0].rotRodIzq;
	brazoder = KeyFrame[0].rodbrazoder;
	brazoizq = KeyFrame[0].rodbrazoizq;
	movcuello= KeyFrame[0].rodmovcuello;
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].rodDerInc = (KeyFrame[playIndex + 1].rorRodDer - KeyFrame[playIndex].rorRodDer) / i_max_steps;
	KeyFrame[playIndex].rotbraderinc = (KeyFrame[playIndex + 1].rodbrazoder - KeyFrame[playIndex].rodbrazoder) / i_max_steps;
	KeyFrame[playIndex].rotbraizqinc = (KeyFrame[playIndex + 1].rodbrazoizq - KeyFrame[playIndex].rodbrazoizq) / i_max_steps;
	KeyFrame[playIndex].rotcuelloinc = (KeyFrame[playIndex + 1].rodmovcuello - KeyFrame[playIndex].rodmovcuello) / i_max_steps;
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	for(int i=0; i<MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].rodbrazoizq = 0;
		KeyFrame[i].rodbrazoder= 0;
		KeyFrame[i].rodmovcuello= 0;
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			rotRodDer += KeyFrame[playIndex].rodDerInc;
			 brazoder+= KeyFrame[playIndex].rotbraderinc;
			brazoizq += KeyFrame[playIndex].rotbraizqinc;
			movcuello += KeyFrame[playIndex].rotcuelloinc;
