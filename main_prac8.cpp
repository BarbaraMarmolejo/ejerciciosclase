...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	t_Ajedrez1.LoadTGA("11.tga");
	t_Ajedrez1.BuildGLTexture();
	t_Ajedrez1.ReleaseImage();

	t_Ajedrez2.LoadTGA("11.tga");
...
void prisma(GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
	...
	glTexCoord2f(0.5f, 0.35f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.75f, 0.35f); glVertex3fv(vertice[3]);
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.35f); glVertex3fv(vertice[1]);
	glTexCoord2f(0.25f, 0.35f); glVertex3fv(vertice[7]);
	...
	glTexCoord2f(0.25f, 0.66f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.5f, 0.66f); glVertex3fv(vertice[1]);
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.25, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.5, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.5, 0.35f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.25f, 0.35f); glVertex3fv(vertice[7]);
	glEnd();
}
